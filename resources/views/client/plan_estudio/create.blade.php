    ...
    <div class="bg-purple-100 p-8 rounded-xl shadow-lg w-full max-w-md transform transition hover:scale-105 duration-200">
        ...
        <form method="POST" action="">
            ...
            <div class="mb-6">
                ...
                <select id="area_estudio" name="area_estudio" class="w-full border-purple-300 bg-purple-50 text-purple-900 rounded-lg shadow-sm focus:ring focus:ring-purple-400 focus:outline-none focus:border-purple-500 transition px-4 py-2">
